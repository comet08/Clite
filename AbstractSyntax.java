...
// Declaration = Variable v; Type t
    ...
    public void display(int r) {
    	Indenter indent = new Indenter(r);
    	indent.display("Variable: " + v + ", Type: " + t);

    }
}

class Functions extends ArrayList<Func>{
	public void display(int r) {
    	for(int i = 0 ; i < this.size(); i++) {
    		this.get(i).display(r+1);
    	}
    }
}
class Func{
    ...
    Func (String i, Type type, Declarations l, Declarations p, Block b) {
        id = i; t = type; 
        locals = l; params = p;
        body = b;
    } 
...
// Conditional = Expression test; Statement thenbranch, elsebranch
    ...
    public void display(int r) {
		...
		indent.display(getClass().toString().substring(6) + ": ");
    	test.display(r+1);
    	thenbranch.display(r+1);
    	if(elsebranch!=null) elsebranch.display(r+1);
    }
}
...
class Return extends Expression{
	...
	public Return() {};
	public Return(String t, Expression r) {
		target =t;
		result = r;
	}
}
...
class Call extends Expression{
	...
	public Call() {};
	public Call(String n, Expressions arg) {
		this.name = n;
		this.args = arg;
	}
